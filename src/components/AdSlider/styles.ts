...
const styles = {
  ...
  tag:
    "absolute end-4 top-4 z-10 rounded-full border border-white/25 bg-white/15 px-2.5 py-1 text-[11px] " +
  ...
  cta:
    ...
    "transition-transform duration-200 ease-brand group-hover:translate-x-0.5 rtl:group-hover:-translate-x-0.5",
