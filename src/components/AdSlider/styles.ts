...
const styles = {
  ...
  viewport: "overflow-hidden rounded-[20px] shadow-card",
  ...
  title: "text-[clamp(20px,2.4vw,30px)] font-semibold leading-tight [text-shadow:0_2px_16px_rgba(0,0,0,.5)]",
  sub: "mt-1 text-[14px] text-white/85 [text-shadow:0_1px_12px_rgba(0,0,0,.5)]",
  cta:
