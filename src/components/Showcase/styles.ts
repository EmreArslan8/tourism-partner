...
const styles = {
  ...
  copy: "section-copy",
  eyebrow: "eyebrow mb-2 !text-brand/75 dark:!text-soft-lavender/75 max-[560px]:mb-[6.4px] [@media(max-height:720px)]:mb-1",
  ...
  arrow:
    "grid h-10 w-10 place-items-center rounded-full border border-white/20 bg-white/95 text-sapphire-deep dark:border-white/25 dark:bg-white/10 dark:text-white dark:backdrop-blur-xl " +
    "shadow-[0_12px_28px_-18px_rgba(0,0,0,.7)] transition-all duration-200 hover:-translate-y-0.5 hover:border-white/40 hover:bg-white hover:text-sapphire dark:hover:border-white/45 dark:hover:bg-white/15 dark:hover:text-white " +
  ...
  panel:
    ...
    "max-[860px]:border max-[860px]:border-line dark:max-[860px]:border-white/15 max-[860px]:shadow-card",
  ...
  categoryText:
    "-mt-1 text-[13px] font-semibold leading-tight text-brand/72 dark:text-soft-lavender/85 " +
    "max-[560px]:mt-0 max-[560px]:text-[12px]",
  meta:
    "flex flex-wrap items-center gap-2.5 text-[13px] font-semibold leading-tight text-ink/62 dark:text-white/70 " +
  ...
  metaIcon: "h-4 w-4 shrink-0 text-brand/60 dark:text-soft-lavender/80 max-[560px]:h-3.5 max-[560px]:w-3.5",
  metaDot: "h-1 w-1 rounded-full bg-line/90 dark:bg-white/30 max-[560px]:h-[3.2px] max-[560px]:w-[3.2px]",
  stars: "rating-star-text text-star",
  ratingNum: "font-bold text-ink dark:text-white",
  reviews: "text-[12.5px] font-semibold text-ink/58 dark:text-white/60 max-[560px]:text-[11.5px] max-[560px]:leading-[1.3]",
  desc:
    "body-muted line-clamp-2 max-w-[56ch] text-ink/68 dark:text-white/70 " +
    "max-[560px]:line-clamp-2 max-[560px]:text-[13px] max-[560px]:leading-[1.35]",
  services: "flex flex-col gap-3 max-[560px]:hidden",
  servicesLabel:
    "text-[14px] font-semibold leading-none tracking-[0] text-ink/78 dark:text-white/85",
  chips: "flex flex-wrap gap-2",
  chip:
    "inline-flex items-center rounded-full bg-[#e8eefc] px-3 py-1.5 text-[13px] font-semibold leading-none text-[#183b82] ring-1 ring-sapphire/10 dark:bg-white/10 dark:text-soft-lavender dark:ring-white/15",
  foot:
    "mt-auto flex items-center gap-3 border-t border-line/90 pt-4 dark:border-white/15 " +
  ...
  quote:
    "inline-flex h-11 w-[156px] items-center justify-center rounded-[10px] border border-line bg-white px-5 text-[14px] font-semibold text-terra dark:border-white/30 dark:bg-white/[.06] dark:text-white dark:backdrop-blur-md " +
    "transition-colors hover:border-terra hover:bg-cream/60 hover:text-terra-deep dark:hover:border-white/50 dark:hover:bg-white/12 dark:hover:text-white " +
    "max-[560px]:h-9 max-[560px]:w-full max-[560px]:border-terra/45 max-[560px]:bg-cream/50 dark:max-[560px]:border-white/30 dark:max-[560px]:bg-white/[.06] max-[560px]:px-4 max-[560px]:text-[13px] max-[560px]:font-bold",
} as const;
