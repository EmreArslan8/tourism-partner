...
export const styles= {
  ...
  inner:
    "container-px flex min-h-[min(760px,100vh)] flex-col items-center justify-center pb-[88px] pt-[160px] text-center " +
    "max-[560px]:min-h-0 max-[560px]:justify-start max-[560px]:pb-9 max-[560px]:pt-[116px]",
  ...
  pop: "mt-5 flex flex-wrap items-center justify-center gap-2 max-[640px]:hidden",
  ...
  stats:
    ...
    "px-2.5 py-3 shadow-[0_16px_40px_-28px_rgba(23,33,120,.42)] backdrop-blur max-[640px]:hidden",
