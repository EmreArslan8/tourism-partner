...
const styles = {
  ...
  lead: "mt-4 max-w-[58ch] text-[15px] font-medium leading-7 !text-[#c7d3f0] max-[640px]:hidden",
  ...
  text: "pb-3 pr-12 text-[14px] font-medium leading-7 text-white/90 max-[560px]:pb-2 max-[560px]:pr-2 max-[560px]:text-[12px] max-[560px]:leading-[1.45]",
} as const;
