...
const styles = {
  ...
  lead: "mt-4 max-w-[58ch] text-[15px] font-medium leading-7 !text-muted min-[1440px]:text-[16.5px] min-[1440px]:leading-8 min-[1800px]:text-[17.5px] max-[640px]:hidden",
  ...
  summary:
    "flex cursor-pointer list-none items-center justify-between gap-5 py-5 text-[15.5px] font-bold leading-snug text-ink " +
    "after:grid after:h-9 after:w-9 after:shrink-0 after:place-items-center after:text-[26px] after:font-normal after:leading-none after:text-brand " +
  ...
  text: "pb-3 pe-12 text-[14px] font-medium leading-7 text-muted min-[1440px]:pb-5 min-[1440px]:text-[15.5px] min-[1440px]:leading-8 min-[1800px]:text-[16.5px] max-[560px]:pb-2 max-[560px]:pe-2 max-[560px]:text-[12px] max-[560px]:leading-[1.45]",
} as const;
