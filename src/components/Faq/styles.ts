...
const styles = {
  ...
  lead: "body-muted mt-4 max-w-[58ch] max-[640px]:hidden",
  ...
  summary:
    "flex cursor-pointer list-none items-center justify-between gap-4 py-2.5 text-[15px] font-semibold text-ink " +
    "transition-colors group-hover:text-terra " +
    "after:grid after:h-7 after:w-7 after:shrink-0 after:place-items-center after:rounded-full " +
  ...
  text: "pb-3.5 pr-10 text-[14px] leading-relaxed text-muted max-[560px]:pr-2",
} as const;
