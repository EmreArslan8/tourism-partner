...
const styles = {
  ...
  stage:
    "grid h-[520px] min-h-0 grid-cols-[minmax(390px,.86fr)_minmax(480px,1.14fr)] overflow-hidden rounded-[28px] border border-line bg-paper " +
    "shadow-card " +
  ...
  tabs: "grid grid-cols-2 gap-1 rounded-[14px] border border-line bg-cream/55 p-1",
  tab:
    "flex h-[38px] items-center justify-center gap-1.5 rounded-[9px] border border-transparent px-2.5 text-[12px] font-bold !text-muted transition-all hover:border-brand/15 hover:bg-paper hover:!text-brand [&>svg]:h-3.5 [&>svg]:w-3.5 min-[1440px]:h-11 min-[1440px]:text-[13.5px] min-[1800px]:h-12 min-[1800px]:text-[14.5px]",
  tabActive:
  ...
  trustChip: "inline-flex items-center gap-2 text-[13px] font-bold text-muted [&>svg]:h-4 [&>svg]:w-4 [&>svg]:text-brand",
} as const;
