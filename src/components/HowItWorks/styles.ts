...
const styles = {
  ...
  lead:
    "section-desc max-w-[560px] pb-1 text-end !text-[#c7d3f0] max-[860px]:max-w-[62ch] max-[860px]:text-start max-[640px]:hidden",
  ...
  steps: "relative mt-4 grid flex-1 auto-rows-fr gap-1.5 before:absolute before:bottom-[52px] before:start-[21px] before:top-[52px] before:w-px before:bg-white/12 before:content-[''] " +
    "max-[640px]:hidden",
  mobileSteps: "mx-3 mb-2 hidden grid-cols-3 auto-rows-[54px] gap-1 max-[640px]:grid",
  stepItem: "relative z-10",
  step:
    "grid h-full min-h-[86px] w-full grid-cols-[44px_minmax(0,1fr)_22px] items-center gap-3 rounded-[16px] border border-transparent px-2 py-2.5 text-start transition-all duration-200 hover:bg-white/[.055] " +
  ...
  stepActive:
    "grid h-full min-h-[86px] w-full grid-cols-[44px_minmax(0,1fr)_22px] items-center gap-3 rounded-[16px] border border-white/30 bg-white/[.085] px-2 py-2.5 text-start shadow-[inset_0_1px_0_rgba(255,255,255,.05)] transition-all duration-200 " +
    "min-[1440px]:min-h-[104px] min-[1440px]:grid-cols-[52px_minmax(0,1fr)_26px] min-[1440px]:gap-4 min-[1440px]:px-3 min-[1800px]:min-h-[116px] " +
    "max-[640px]:min-h-0 max-[640px]:grid-cols-1 max-[640px]:place-items-center max-[640px]:gap-0.5 max-[640px]:rounded-[10px] max-[640px]:px-1 max-[640px]:py-1 max-[640px]:text-center",
  stepMarker:
  ...
  previewGlow:
    "pointer-events-none absolute -end-20 -top-24 h-80 w-80 rounded-full bg-[radial-gradient(closest-side,rgba(53,66,238,.16),transparent_70%)]",
  previewTopbar:
    "relative z-10 flex h-8 shrink-0 items-center gap-1.5 border-b border-sapphire/10 bg-white/[.55] px-3 [&>span]:h-1.5 [&>span]:w-1.5 [&>span]:rounded-full [&>span]:bg-sapphire/20 [&>em]:mx-auto [&>em]:pe-6 [&>em]:text-[9px] [&>em]:font-semibold [&>em]:not-italic [&>em]:text-muted/[.65] " +
  ...
  mobileUiStats: "grid grid-cols-2 gap-2 [&>span]:rounded-[8px] [&>span]:bg-[#e8eefc] [&>span]:p-2 [&>span]:text-[10px] [&>span]:font-black [&>span]:text-brand [&_small]:ms-1 [&_small]:text-[6.5px] [&_small]:font-bold [&_small]:text-muted",
  ...
  mobileUiFlow: "relative grid grid-cols-3 before:absolute before:start-[17%] before:end-[17%] before:top-3 before:h-px before:bg-line [&>span]:relative [&>span]:z-10 [&>span]:flex [&>span]:flex-col [&>span]:items-center [&>span]:gap-1 [&_i]:grid [&_i]:h-6 [&_i]:min-w-6 [&_i]:place-items-center [&_i]:rounded-full [&_i]:bg-[#e8eefc] [&_i]:px-1 [&_i]:text-[7px] [&_i]:font-black [&_i]:not-italic [&_i]:text-brand [&_small]:text-[7px] [&_small]:font-bold [&_small]:text-muted",
  ...
  quoteFlow: "relative grid grid-cols-3 gap-2 before:absolute before:start-[16%] before:end-[16%] before:top-3 before:h-px before:bg-line before:content-[''] [&>span]:relative [&>span]:z-10 [&>span]:flex [&>span]:flex-col [&>span]:items-center [&>span]:gap-1.5 [&_i]:grid [&_i]:h-6 [&_i]:min-w-6 [&_i]:place-items-center [&_i]:rounded-full [&_i]:bg-[#e8eefc] [&_i]:px-1 [&_i]:text-[8px] [&_i]:font-black [&_i]:not-italic [&_i]:text-brand [&_small]:text-center [&_small]:text-[9px] [&_small]:font-bold [&_small]:text-muted",
