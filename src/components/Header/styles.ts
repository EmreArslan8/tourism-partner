const styles = {
  ...
  navLinkOnLight: "!text-ink/75 hover:!text-brand dark:!text-white/75 dark:hover:!text-white",
  navLinkActiveOnLight: "!text-brand dark:!text-white",
  ...
  separatorOnLight: "!bg-brand/15 dark:!bg-white/20",
} as const;
