/* HeroSearch — canlı statik formdaki kompakt, segmentli arama çubuğu. */
 const styles= {
  form:
    ...
    "bg-white/90 p-1 text-start shadow-[0_18px_46px_-28px_rgba(23,33,120,.38)] backdrop-blur-2xl " +
  ...
  selectIcon: "pointer-events-none absolute start-0 top-1/2 h-[15px] w-[15px] -translate-y-1/2 text-[#8a93ad]",
  selectPad: "ps-[21px]",
  select:
    "w-full cursor-pointer appearance-none overflow-hidden text-ellipsis whitespace-nowrap border-0 bg-transparent pe-[20px] text-[14px] font-medium leading-5 text-ink focus:outline-none disabled:cursor-not-allowed disabled:opacity-45 min-[1440px]:text-[15.5px] min-[1440px]:leading-6 min-[1800px]:text-[16.5px] max-[1024px]:text-[16px]",
  chevron: "pointer-events-none absolute end-0 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-[#66708f]",
  submit:
    "inline-flex shrink-0 items-center justify-center gap-2 rounded-[9px] border-0 bg-sapphire-top px-7 py-2 text-[14px] font-bold tracking-[.01em] text-white " +
