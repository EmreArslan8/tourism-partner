...
export const styles= {
  ...
  field:
    "flex min-w-[148px] flex-col justify-center px-4 py-1.5 max-[760px]:min-w-0 max-[760px]:rounded-[10px] max-[760px]:border max-[760px]:border-line max-[520px]:px-[9px] max-[520px]:py-2",
  grow: "min-w-[200px] flex-1 max-[760px]:min-w-0",
  ...
  submit:
    ...
    "shadow-[0_12px_26px_-14px_rgba(53,66,238,.75)] transition-all duration-200 ease-brand hover:-translate-y-px hover:bg-terra-deep focus:outline-none focus-visible:ring-2 focus-visible:ring-terra focus-visible:ring-offset-2 " +
