/* SupplierCard — tedarikçi kartı ortak görünümü (vitrin + listeleme). */
 const styles= {
  ...
  flag:
    "absolute left-3 top-3 z-[3] rounded-[8px] border-0 bg-paper/95 px-3 py-1.5 text-[11px] " +
    "font-bold normal-case tracking-normal text-ink shadow-[0_8px_18px_-10px_rgba(0,0,0,.5)] backdrop-blur-sm",
  favorite: "absolute right-3 top-3 z-[5] pointer-events-auto",
  cover: "relative flex h-[240px] shrink-0 items-center justify-center overflow-hidden max-[640px]:h-[230px]",
  ...
  name: "line-clamp-2 min-w-0 font-display text-[22px] font-medium leading-[1.18] tracking-[-.022em] text-ink max-[640px]:text-[20px]",
