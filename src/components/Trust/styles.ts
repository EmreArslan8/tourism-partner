...
const styles = {
  ...
  icon: "grid h-11 w-11 shrink-0 place-items-center rounded-[12px] bg-white/10 text-white ring-1 ring-white/15 min-[1440px]:h-[52px] min-[1440px]:w-[52px] min-[1440px]:rounded-[14px] min-[1440px]:[&_svg]:h-[24px] min-[1440px]:[&_svg]:w-[24px] min-[1800px]:h-14 min-[1800px]:w-14 max-[560px]:h-10 max-[560px]:w-10 max-[560px]:rounded-[10px] max-[560px]:[&_svg]:h-[20px] max-[560px]:[&_svg]:w-[20px]",
  body: "flex min-w-0 flex-wrap items-baseline justify-center gap-x-1.5 max-[560px]:block",
  itemTitle: "text-[12.5px] font-semibold uppercase tracking-[.16em] text-white/90 min-[1440px]:text-[13.5px] min-[1800px]:text-[14.5px] max-[900px]:text-[11px] max-[560px]:flex max-[560px]:min-h-[2.4em] max-[560px]:items-center max-[560px]:justify-center max-[560px]:text-[9px] max-[560px]:leading-[1.2] max-[560px]:tracking-[.08em]",
  itemDesc: "text-[13px] font-medium leading-snug text-white/65 min-[1440px]:text-[14px] min-[1800px]:text-[15px] max-[900px]:text-[12.5px] max-[560px]:mt-1.5 max-[560px]:block max-[560px]:text-[9px] max-[560px]:leading-[1.35]",
} as const;
