...
const styles = {
  ...
  panel:
    ...
    "border border-white/[.18] bg-[linear-gradient(110deg,theme(colors.sapphire-top/.94),theme(colors.sapphire/.9)_48%,theme(colors.sapphire-deep/.94))] px-7 py-6 shadow-[0_26px_76px_-38px_rgba(36,17,63,.72)] backdrop-blur-xl " +
    "before:absolute before:inset-0 before:-z-10 before:bg-[radial-gradient(circle_at_13%_18%,rgba(255,255,255,.2),transparent_26%),radial-gradient(circle_at_86%_30%,theme(colors.soft-lavender/.2),transparent_32%),linear-gradient(118deg,rgba(255,255,255,.06),transparent_38%,rgba(255,255,255,.08))] " +
    "after:absolute after:end-[-12%] after:top-1/2 after:-z-10 after:h-[170%] after:w-[34%] after:-translate-y-1/2 after:rotate-[-12deg] after:bg-white/[.07] after:blur-[1px] " +
    "max-[860px]:grid-cols-1 max-[860px]:gap-5 max-[860px]:px-5 max-[860px]:py-5 " +
    "max-[560px]:gap-3 max-[560px]:rounded-[12px] max-[560px]:px-4 max-[560px]:py-4",
  ...
  sub:
    "mt-3 max-w-[54ch] text-[15px] font-medium leading-[1.5] !text-soft-lavender " +
  ...
  primary:
    ...
    "[&>svg]:transition-transform [&>svg]:duration-200 [&>svg]:ease-brand hover:[&>svg]:translate-x-0.5 rtl:hover:[&>svg]:-translate-x-0.5 " +
    "max-[980px]:min-h-[50px] max-[980px]:px-6 " +
    "max-[560px]:min-h-[48px] max-[560px]:w-full max-[560px]:rounded-[8px] max-[560px]:px-5 max-[560px]:text-[14px]",
} as const;
