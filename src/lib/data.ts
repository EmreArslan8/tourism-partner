...
export const BUSINESSES: Business[] = [
  ...
  // ---- ULAŞIM ----
  { id: 24, group: "ulasim", type: "VIP Transfer", name: "Akdeniz VIP Transfer", country: "Türkiye", city: "Antalya", district: "Muratpaşa", coords: [36.890, 30.710],
    desc: "Havalimanı, otel ve şehirlerarası VIP transfer operasyonu. Acenteler için komisyonlu ve cari hesaplı çalışma.",
    rating: 4.8, reviews: 118, tag: "VIP", verified: true, sponsored: false,
    attributes: ["yetkili-transfer", "vip-arac", "minibus", "komisyonlu", "cari-hesap", "para-try"] },
  { id: 25, group: "ulasim", type: "Rent A Car", name: "Ege Fleet Rent A Car", country: "Türkiye", city: "Muğla", district: "Bodrum", coords: [37.038, 27.430],
    desc: "KABİS kayıtlı rent a car filosu. Sezonluk acente anlaşmaları ve çoklu araç tahsis süreçleri.",
    rating: 4.6, reviews: 84, tag: "KABİS", verified: true, sponsored: false,
    attributes: ["kabis-kaydi", "rent-a-car", "talep-uzerine", "vadeli", "para-try"] },
  ...
  // ---- EĞLENCE ----
  { id: 14, group: "aktivite", type: "Balon Turu", name: "Göktürk Balloons", country: "Türkiye", city: "Nevşehir", district: "Göreme", coords: [38.643, 34.830],
  ...
  { id: 15, group: "aktivite", type: "Tekne / Yat", name: "Mavi Yol Yachting", country: "Türkiye", city: "Muğla", district: "Marmaris", coords: [36.850, 28.270],
  ...
  { id: 16, group: "aktivite", type: "Adrenalin Sporları", name: "Pamukkale Adventures", country: "Türkiye", city: "Denizli", district: "Pamukkale", coords: [37.920, 29.120],
  ...
  { id: 17, group: "aktivite", type: "Tekne / Yat", name: "Bosphorus Line Cruises", country: "Türkiye", city: "İstanbul", district: "Beşiktaş", coords: [41.043, 29.007],
  ...
  { id: 22, group: "aktivite", type: "Binicilik", name: "Atlı Doğa Binicilik", country: "Türkiye", city: "Ankara", district: "Gölbaşı", coords: [39.790, 32.800],
