                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                  <tr>
                    <td style="background:#4c1d95;padding:34px 38px;">
                      <div style="display:inline-block;margin-bottom:16px;border-radius:999px;background:#6d28d9;padding:7px 12px;color:#ffffff;font-size:11px;font-weight:800;letter-spacing:0.7px;">PROFILE APPROVED</div>
                      <h1 style="margin:0 0 10px;color:#ffffff;font-size:28px;line-height:34px;letter-spacing:-0.7px;">Welcome to Tourism Partner!</h1>
                      <p style="margin:0;color:#ede9fe;font-size:15px;line-height:24px;"><strong style="color:#ffffff;">${safeBusinessName}</strong> has been approved.</p>
                    </td>
                  </tr>
                  <tr>
