...
const styles = {
  ...
  eyebrow: "text-[12px] font-extrabold uppercase tracking-[.14em] text-brand/70",
  title: "mt-2 text-[32px] font-extrabold leading-tight tracking-tight text-ink sm:text-[38px] min-[1440px]:text-[46px] min-[1800px]:text-[52px]",
  sub: "mt-3 text-[15.5px] font-medium leading-relaxed text-muted min-[1440px]:text-[17px] min-[1800px]:text-[18px]",
