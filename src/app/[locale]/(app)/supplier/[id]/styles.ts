 const styles = {
  ...
  eyebrow: "mb-1 text-[12px] font-extrabold uppercase tracking-[.08em] text-terra-deep dark:text-border-purple",
  ...
  partnersSub: "mt-1 text-[13px] font-medium leading-5 text-muted",
  partnersGrid: "grid gap-3 min-[640px]:grid-cols-2",
  partnersEmpty:
    "rounded-[10px] border border-dashed border-line bg-cream/40 px-4 py-3.5 text-[13.5px] font-medium leading-6 text-muted",
  partnerItem:
    "flex min-w-0 items-center gap-3 rounded-[10px] border border-line bg-cream/35 px-3.5 py-3 transition-all hover:border-terra/45 hover:shadow-[0_1px_2px_rgba(2,6,23,.45)]",
  partnerMark:
