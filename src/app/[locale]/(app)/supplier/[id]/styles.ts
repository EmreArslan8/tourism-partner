 const styles = {
  ...
  partnerItem:
    "flex min-w-0 items-center gap-3 rounded-[10px] border border-line bg-white px-3.5 py-3 transition-all hover:border-terra/45 hover:shadow-[0_1px_2px_rgba(2,6,23,.45)]",
  partnerMark:
