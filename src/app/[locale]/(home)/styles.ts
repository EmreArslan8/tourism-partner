...
const styles = {
  ...
  panelTour: panelBase,
  panelFaq: `${panelBase} max-[640px]:!justify-center max-[640px]:overflow-y-auto max-[640px]:py-3`,
  panelStack: `${panelBase} gap-5 max-[640px]:!justify-center max-[640px]:gap-3.5`,
