...
export const fontSize: Record<string, FontSizeValue> = {
  ...
  "section-compact": ["1.5rem", { lineHeight: "1.2", letterSpacing: "-0.02em" }],
  ...
  "eyebrow-compact": ["0.75rem", { lineHeight: "1.2", letterSpacing: "0.128em" }],
  small: ["0.84375rem", { lineHeight: "1.6" }],
  meta: ["0.8125rem", { lineHeight: "1.6" }],
  "body-compact": ["0.9375rem", { lineHeight: "1.6" }],
  ...
  "step-number-compact": ["0.8125rem", { lineHeight: "1" }],
  "step-title": ["0.96875rem", { lineHeight: "1.25" }],
  "step-title-compact": ["0.875rem", { lineHeight: "1.25" }],
