...
export const s = {
  ...
  overlay:
    ...
    "bg-[radial-gradient(ellipse_58%_72%_at_50%_42%,rgba(255,255,255,.94)_0%,rgba(255,255,255,.82)_48%,rgba(255,255,255,.34)_74%,rgba(245,246,248,.08)_100%),linear-gradient(180deg,rgba(255,255,255,.28)_0%,rgba(255,255,255,.02)_46%,rgba(245,246,248,.96)_100%)]",
  grain: "pointer-events-none absolute inset-0 -z-10 opacity-[.07] mix-blend-multiply",
  inner:
    "container-px flex min-h-[min(760px,100vh)] flex-col items-center justify-center py-[88px] text-center max-[560px]:min-h-[560px] max-[560px]:py-16",
  ...
  sub: "mx-auto mt-4 max-w-[58ch] text-[15px] sm:text-[17px] text-[#3f4b5f] [text-shadow:0_1px_14px_rgba(255,255,255,.78)]",
  ...
  popLink:
    ...
    "shadow-[0_8px_20px_-16px_rgba(16,24,40,.4)] transition-colors hover:border-pine hover:bg-pine hover:text-white",
  stats:
    "mt-9 flex flex-wrap items-center justify-center rounded-pill border border-ink/15 bg-white/75 " +
    "px-2.5 py-3 shadow-[0_16px_40px_-28px_rgba(16,24,40,.4)] backdrop-blur",
