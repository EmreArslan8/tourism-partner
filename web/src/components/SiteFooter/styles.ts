...
export const s = {
  ...
  brandType: "flex flex-col font-display leading-[.92]",
  brandTop: "text-[15px] font-semibold tracking-[.14em] text-cream",
  brandBottom: "text-[11px] font-medium tracking-[.26em] text-terra",
